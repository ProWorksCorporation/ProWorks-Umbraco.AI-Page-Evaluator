...
- AI text recommendations for Fail and Warn checks — shows the current field value alongside the suggestion; apply directly to plain text and Tags fields, or copy to clipboard for Rich Text. Third-party editor aliases can be enabled for recommendations via `appsettings.json`

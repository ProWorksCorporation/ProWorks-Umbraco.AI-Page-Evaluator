const e = {
  evaluatePage: {
    ...
    parseFailedWarning: "Die KI-Antwort konnte nicht als strukturierter Bericht formatiert werden. Die Rohausgabe wird unten angezeigt.",
    parseFailedLinkText: "Bewertungs-Prompt verfeinern",
    parseFailedSuffix: "um die strukturierte Ausgabe zu verbessern.",
    // Modal: AI error
    aiErrorMessage: "Die Bewertung konnte nicht abgeschlossen werden. Der KI-Anbieter hat einen Fehler zurückgegeben.",
    temporaryRetryableMessage: "Der KI-Anbieter ist vorübergehend nicht verfügbar. Bitte versuchen Sie es in Kürze erneut.",
    connectivityMessage: "Der KI-Anbieter konnte nicht erreicht werden. Überprüfen Sie Ihre Verbindung und versuchen Sie es erneut.",
    authenticationConfigurationMessage: "Die KI-Verbindung erfordert Aufmerksamkeit. Wenden Sie sich an Ihren Administrator, um die Anmeldedaten oder die Konfiguration des KI-Profils zu überprüfen.",
    // 003-upgrade-umbraco-17-6: gateway/culture errors, variability notice, rich-text Apply
    gatewayTimeoutMessage: "Die Auswertung hat länger gedauert, als Ihr Netzwerk-Gateway erlaubt, und wurde daher abgebrochen. Bitte versuchen Sie es erneut. Wenn das weiterhin passiert, bitten Sie Ihren Administrator, das Proxy- oder CDN-Timeout für das Backoffice zu erhöhen.",
    gatewayUnreachableMessage: "Der Server war über Ihr Netzwerk-Gateway nicht erreichbar. Überprüfen Sie Ihre Verbindung und versuchen Sie es erneut.",
    cultureNotCreatedMessage: "Diese Sprachversion der Seite hat noch keinen Inhalt, daher gibt es nichts auszuwerten.",
    invalidCultureMessage: "Die ausgewählte Sprache konnte nicht ausgewertet werden. Laden Sie die Seite neu und versuchen Sie es erneut.",
    samplingVariesNotice: "Dieser Bericht wurde von einem KI-Modell erstellt, das keine deterministische Ausgabe unterstützt. Die Bewertungen können daher abweichen, wenn Sie die Auswertung erneut ausführen.",
    rteApplyBlockedMessage: "Dieser Vorschlag würde eingebettete Inhalte (Blöcke oder Medien) aus dem Feld entfernen und kann daher nicht automatisch übernommen werden. Kopieren Sie ihn und bearbeiten Sie das Feld stattdessen manuell.",
    applyFailedMessage: "Der Vorschlag konnte nicht auf dieses Feld angewendet werden. Ihr vorhandener Inhalt wurde nicht verändert.",
    retryButton: "Erneut versuchen",
    // Modal: guardrail block
    guardrailBlockedMessage: "Die Bewertung wurde durch eine Umbraco.AI-Guardrail-Richtlinie blockiert. Überprüfen Sie die im KI-Profil konfigurierten Guardrail-Regeln.",
  ...
  evaluatorConfig: {
    ...
    samplingVariesNotice: "Das ausgewählte KI-Profil verwendet ein Modell, das keine deterministische Ausgabe unterstützt. Die Bewertungen können zwischen wiederholten Auswertungen abweichen.",
    // Workspace: list
...
//# sourceMappingURL=de-Dre3Wgo1.js.map

const e = {
  evaluatePage: {
    ...
    parseFailedWarning: "La risposta dell'IA non è stata formattata come report strutturato. Di seguito viene mostrato l'output non elaborato.",
    parseFailedLinkText: "Affina il prompt del valutatore",
    parseFailedSuffix: "per migliorare l'output strutturato.",
    // Modal: AI error
    aiErrorMessage: "Non è stato possibile completare la valutazione. Il provider IA ha restituito un errore.",
    temporaryRetryableMessage: "Il provider IA è temporaneamente non disponibile. Riprova tra un momento.",
    connectivityMessage: "Impossibile raggiungere il provider IA. Controlla la connessione e riprova.",
    authenticationConfigurationMessage: "La connessione IA richiede attenzione. Contatta l'amministratore per verificare le credenziali o la configurazione del profilo IA.",
    // 003-upgrade-umbraco-17-6: gateway/culture errors, variability notice, rich-text Apply
    gatewayTimeoutMessage: "La valutazione ha richiesto più tempo di quanto consentito dal gateway di rete ed è stata interrotta. Riprova. Se continua a succedere, chiedi all'amministratore di aumentare il timeout del proxy o della CDN per il backoffice.",
    gatewayUnreachableMessage: "Impossibile raggiungere il server tramite il gateway di rete. Controlla la connessione e riprova.",
    cultureNotCreatedMessage: "Questa versione linguistica della pagina non ha ancora contenuti, quindi non c'è nulla da valutare.",
    invalidCultureMessage: "Non è stato possibile valutare la lingua selezionata. Ricarica la pagina e riprova.",
    samplingVariesNotice: "Questo report è stato generato da un modello di IA che non supporta output deterministico, quindi i punteggi potrebbero variare se esegui di nuovo la valutazione.",
    rteApplyBlockedMessage: "Questo suggerimento rimuoverebbe contenuti incorporati (blocchi o media) dal campo, quindi non può essere applicato automaticamente. Copialo e modifica il campo manualmente.",
    applyFailedMessage: "Non è stato possibile applicare il suggerimento a questo campo. Il contenuto esistente non è stato modificato.",
    retryButton: "Riprova",
    // Modal: guardrail block
    guardrailBlockedMessage: "La valutazione è stata bloccata da una policy guardrail di Umbraco.AI. Rivedi le regole guardrail configurate sul profilo IA.",
  ...
  evaluatorConfig: {
    ...
    samplingVariesNotice: "Il profilo IA selezionato usa un modello che non supporta output deterministico. I punteggi della valutazione potrebbero variare tra un'esecuzione e l'altra.",
    // Workspace: list
...
//# sourceMappingURL=it-DmhaUUjd.js.map

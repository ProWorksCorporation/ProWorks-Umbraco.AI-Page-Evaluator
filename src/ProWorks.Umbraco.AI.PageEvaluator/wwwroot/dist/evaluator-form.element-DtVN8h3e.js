...
import { f as b, c as $, h as y, B as _, i as C, u as T, j as z } from "./entry-point-3e4lGqw9.js";
const g = [
  {
    id: "required-fields",
...
var S = Object.defineProperty, A = Object.getOwnPropertyDescriptor, d = (e, t, i, a) => {
  for (var r = a > 1 ? void 0 : a ? A(t, i) : t, c = e.length - 1, h; c >= 0; c--)
...
var E = Object.defineProperty, w = Object.getOwnPropertyDescriptor, n = (e, t, i, a) => {
  for (var r = a > 1 ? void 0 : a ? w(t, i) : t, c = e.length - 1, h; c >= 0; c--)
    (h = e[c]) && (r = (a ? h(t, i, r) : h(r)) || r);
  return a && r && E(t, i, r), r;
};
let l = class extends v {
  constructor() {
    super(...arguments), this.configId = null, this.name = "", this._description = "", this._documentTypeAlias = "", this._profileId = "", this._contextId = "", this._promptText = "", this._scoringEnabled = !1, this._recommendationsEnabled = !0, this._version = 0, this._errors = {}, this._temperatureSupported = null, this._loadError = null, this._promptBuilderOpen = !1, this._propertyAliases = [], this._availableProperties = [], this._docTypeDisplayName = "", this._docTypeSuggestions = [], this._docTypeShowSuggestions = !1, this._docTypeSearchTimer = null;
  }
  updated(e) {
  ...
  _resetFields() {
    this._loadError = null, this._description = "", this._documentTypeAlias = "", this._docTypeDisplayName = "", this._docTypeSuggestions = [], this._docTypeShowSuggestions = !1, this._profileId = "", this._temperatureSupported = null, this._contextId = "", this._promptText = "", this._scoringEnabled = !1, this._recommendationsEnabled = !0, this._version = 0, this._propertyAliases = [], this._availableProperties = [], this._errors = {}, this._promptBuilderOpen = !1, this.dispatchEvent(new CustomEvent("evaluator-name-loaded", {
      detail: { name: "" },
      bubbles: !0,
      composed: !0
    }));
  ...
  _onProfileChange(e) {
    this._profileId = e, this._temperatureSupported = null, e && this.refreshSamplingSupport(e);
  }
  /**
   ...
   */
  async refreshSamplingSupport(e) {
    try {
      const { temperatureSupported: t } = await C(e);
      if (!this.isConnected || this._profileId !== e) return;
      this._temperatureSupported = t;
    } catch {
      if (!this.isConnected || this._profileId !== e) return;
...
n([
  s()
], l.prototype, "_temperatureSupported", 2);
n([
  s()
...
//# sourceMappingURL=evaluator-form.element-DtVN8h3e.js.map

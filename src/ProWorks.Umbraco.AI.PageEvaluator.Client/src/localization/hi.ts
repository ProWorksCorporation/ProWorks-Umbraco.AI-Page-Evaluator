export default {
  evaluatePage: {
    ...
    parseFailedWarning:
      'AI की प्रतिक्रिया को एक संरचित रिपोर्ट के रूप में फ़ॉर्मेट नहीं किया जा सका। नीचे मूल आउटपुट दिखाया गया है।',
    parseFailedLinkText: 'मूल्यांकनकर्ता प्रॉम्प्ट को परिष्कृत करें',
    parseFailedSuffix: 'संरचित आउटपुट को बेहतर बनाने के लिए।',

    // Modal: AI error
    aiErrorMessage:
      'मूल्यांकन पूरा नहीं किया जा सका। AI प्रदाता ने त्रुटि लौटाई।',
    temporaryRetryableMessage:
      'AI प्रदाता अस्थायी रूप से अनुपलब्ध है। कृपया कुछ ही देर में फिर से प्रयास करें।',
    connectivityMessage:
      'AI प्रदाता तक नहीं पहुँचा जा सका। कृपया अपना कनेक्शन जाँचें और फिर से प्रयास करें।',
    authenticationConfigurationMessage:
      'AI कनेक्शन पर ध्यान देने की आवश्यकता है। कृपया AI प्रोफ़ाइल की क्रेडेंशियल या कॉन्फ़िगरेशन जाँचने के लिए अपने व्यवस्थापक से संपर्क करें।',
    // 003-upgrade-umbraco-17-6: gateway/culture errors, variability notice, rich-text Apply
    gatewayTimeoutMessage:
      "मूल्यांकन में आपके नेटवर्क गेटवे की अनुमत सीमा से अधिक समय लगा, इसलिए इसे रोक दिया गया। कृपया फिर से प्रयास करें। यदि ऐसा बार-बार हो, तो अपने व्यवस्थापक से बैकऑफ़िस के लिए प्रॉक्सी या CDN टाइमआउट बढ़ाने को कहें।",
    gatewayUnreachableMessage:
      "आपके नेटवर्क गेटवे के माध्यम से सर्वर तक नहीं पहुँचा जा सका। अपना कनेक्शन जाँचें और फिर से प्रयास करें।",
    cultureNotCreatedMessage:
      "पेज के इस भाषा संस्करण में अभी कोई सामग्री नहीं है, इसलिए मूल्यांकन के लिए कुछ नहीं है।",
    invalidCultureMessage:
      "चुनी गई भाषा का मूल्यांकन नहीं किया जा सका। पेज को फिर से लोड करें और दोबारा प्रयास करें।",
    samplingVariesNotice:
      "यह रिपोर्ट ऐसे AI मॉडल ने बनाई है जो निर्धारित (deterministic) आउटपुट का समर्थन नहीं करता, इसलिए मूल्यांकन दोबारा चलाने पर स्कोर बदल सकते हैं।",
    rteApplyBlockedMessage:
      "यह सुझाव फ़ील्ड से एम्बेडेड सामग्री (ब्लॉक या मीडिया) हटा देगा, इसलिए इसे स्वचालित रूप से लागू नहीं किया जा सकता। इसे कॉपी करें और हाथ से संपादित करें।",
    applyFailedMessage:
      "इस फ़ील्ड पर सुझाव लागू नहीं किया जा सका। आपकी मौजूदा सामग्री नहीं बदली गई है।",
    retryButton: 'फिर से प्रयास करें',

    // Modal: guardrail block
    guardrailBlockedMessage:
      'Umbraco.AI गार्डरेल नीति द्वारा मूल्यांकन को अवरुद्ध कर दिया गया था। AI प्रोफ़ाइल पर कॉन्फ़िगर किए गए गार्डरेल नियमों की समीक्षा करें।',
  ...
  evaluatorConfig: {
    ...
    samplingVariesNotice:
      "चुनी गई AI प्रोफ़ाइल ऐसे मॉडल का उपयोग करती है जो निर्धारित (deterministic) आउटपुट का समर्थन नहीं करता। दोबारा चलाने पर मूल्यांकन स्कोर बदल सकते हैं।",
    // Workspace: list

export default {
  evaluatePage: {
    ...
    parseFailedWarning:
      "La réponse de l'IA n'a pas pu être mise en forme comme un rapport structuré. La sortie brute est affichée ci-dessous.",
    parseFailedLinkText: "Affiner l'invite de l'évaluateur",
    parseFailedSuffix: 'pour améliorer la sortie structurée.',

    // Modal: AI error
    aiErrorMessage:
      "L'évaluation n'a pas pu être terminée. Le fournisseur d'IA a renvoyé une erreur.",
    temporaryRetryableMessage:
      "Le fournisseur d'IA est temporairement indisponible. Veuillez réessayer dans un instant.",
    connectivityMessage:
    ...
    guardrailBlockedMessage:
      "L'évaluation a été bloquée par une politique de garde-fou Umbraco.AI. Vérifiez les règles de garde-fou configurées sur le profil IA.",

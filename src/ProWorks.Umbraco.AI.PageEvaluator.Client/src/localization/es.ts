export default {
  evaluatePage: {
    ...
    parseFailedWarning:
      'La respuesta de la IA no se pudo formatear como un informe estructurado. A continuación se muestra la salida sin procesar.',
    parseFailedLinkText: 'Ajustar el prompt del evaluador',
    parseFailedSuffix: 'para mejorar la salida estructurada.',

    // Modal: AI error
    aiErrorMessage:
      'No se pudo completar la evaluación. El proveedor de IA devolvió un error.',
    temporaryRetryableMessage:
      'El proveedor de IA no está disponible temporalmente. Vuelva a intentarlo en un momento.',
    connectivityMessage:
    ...
    guardrailBlockedMessage:
      'La evaluación fue bloqueada por una política de barreras de protección de Umbraco.AI. Revise las reglas de barrera configuradas en el perfil de IA.',

export default {
  evaluatePage: {
    ...
    parseFailedWarning:
      'AI-svaret kunne ikke formateres som en struktureret rapport. Rådataene vises nedenfor.',
    parseFailedLinkText: 'Finjuster evaluator-prompten',
    parseFailedSuffix: 'for at forbedre den strukturerede output.',

    // Modal: AI error
    aiErrorMessage:
      'Evalueringen kunne ikke gennemføres. AI-udbyderen returnerede en fejl.',
    temporaryRetryableMessage:
      'AI-udbyderen er midlertidigt utilgængelig. Prøv igen om et øjeblik.',
    connectivityMessage:
    ...
    guardrailBlockedMessage:
      'Evalueringen blev blokeret af en Umbraco.AI-guardrail-politik. Gennemgå guardrail-reglerne, der er konfigureret på AI-profilen.',
